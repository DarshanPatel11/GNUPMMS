...
class Projects(models.Model):
    ...
    AddStudentApprovalRights = models.IntegerField(default = 0)
    RemoveStudentApprovalRights = models.IntegerField(default = 0)
    ChangeInternalGuideRights = models.IntegerField(default = 0)
    ChangeExternalGuideRights = models.IntegerField(default = 0)
    ChangeMentorGuideRights = models.IntegerField(default = 0)
    IsActive = models.BooleanField(default=True)
